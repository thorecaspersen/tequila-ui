  ...
  return (
    <Article>
      ...
      <ArticleText>
        ...
        scelerisque eleifend donec pretium. Et netus et malesuada fames.
        Pellentesque habitant morbi tristique senectus. Interdum velit euismod
        in pellentesque. Ut ornare lectus sit amet. Iaculis at erat pellentesque
        adipiscing commodo elit. Donec adipiscing tristique risus nec feugiat in
        fermentum posuere. Mi ipsum faucibus vitae aliquet nec ullamcorper sit
        amet. Et magnis dis parturient montes nascetur ridiculus mus mauris
        vitae. Integer malesuada nunc vel risus commodo viverra maecenas
        accumsan lacus. Ultrices in iaculis nunc sed augue lacus. Sed nisi lacus
        sed viverra tellus in hac habitasse. Velit egestas dui id ornare arcu
        odio ut.
      </ArticleText>
      <ArticleQuote>
      ...
      <ArticleBullets>
        ...
        <li>I’m just as scared of matrix as I am for overpopulation on Mars</li>
      </ArticleBullets>
      <ArticleText>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua. Phasellus faucibus
